...
% fn = 'D:\paper\论文7(投)--AIChE鲁棒混合BayesianPCR在软测量中的应用\AIChE\Pictures\Fig2a'; 
% print(gcf, '-depsc2', fn)
...
set(legend_h, 'fontsize',20,'fontweight','b')
set(plot_h, 'MarkerSize', 10)
% fn = 'D:\paper\论文7(投)--AIChE鲁棒混合BayesianPCR在软测量中的应用\AIChE\Pictures\Fig2b'; 
% print(gcf, '-depsc2', fn)
...
set(legend_h, 'fontsize',20,'fontweight','b')
set(plot_h, 'MarkerSize', 10)
% fn = 'D:\paper\论文7(投)--AIChE鲁棒混合BayesianPCR在软测量中的应用\AIChE\Pictures\Fig2c'; 
% print(gcf, '-depsc2', fn)
...
% fn = 'D:\paper\论文7(投)--AIChE鲁棒混合BayesianPCR在软测量中的应用\AIChE\Pictures\Fig2d'; 
% print(gcf, '-depsc2', fn)
...
set(legend_h, 'fontsize',20,'fontweight','b')
set(plot_h, 'MarkerSize', 10)
% fn = 'D:\paper\论文7(投)--AIChE鲁棒混合BayesianPCR在软测量中的应用\AIChE\Pictures\Fig2e'; 
% print(gcf, '-depsc2', fn)
...
set(legend_h, 'fontsize',20,'fontweight','b')
set(plot_h, 'MarkerSize', 10)
% fn = 'D:\paper\论文7(投)--AIChE鲁棒混合BayesianPCR在软测量中的应用\AIChE\Pictures\Fig2f'; 
% print(gcf, '-depsc2', fn)
...
set(legend_h, 'fontsize',20,'fontweight','b')
set(plot_h, 'MarkerSize', 10)
% fn = 'D:\paper\论文7(投)--AIChE鲁棒混合BayesianPCR在软测量中的应用\AIChE\Pictures\Fig2g'; 
% print(gcf, '-depsc2', fn)
...
set(legend_h, 'fontsize',20,'fontweight','b')
set(plot_h, 'MarkerSize', 7)
% fn = 'D:\paper\论文7(投)--AIChE鲁棒混合BayesianPCR在软测量中的应用\AIChE\Pictures\Fig2h'; 
% print(gcf, '-depsc2', fn)
...
% set(legend_h, 'fontsize',20,'fontweight','b')
% set(plot_h, 'MarkerSize', 7)
% % fn = 'D:\paper\论文7(投)--AIChE鲁棒混合BayesianPCR在软测量中的应用\AIChE\Pictures\Fig3a'; 
% % print(gcf, '-depsc2', fn)
% 
% figure(12)
...
% % fn = 'D:\paper\论文7(投)--AIChE鲁棒混合BayesianPCR在软测量中的应用\AIChE\Pictures\Fig3b'; 
% % print(gcf, '-depsc2', fn)
% 
% figure(13)
...
% set(legend_h, 'fontsize',20,'fontweight','b')
% set(plot_h, 'MarkerSize', 10)
% % fn = 'D:\paper\论文7(投)--AIChE鲁棒混合BayesianPCR在软测量中的应用\AIChE\Pictures\Fig3c'; 
% % print(gcf, '-depsc2', fn)
% 
% figure(14)
...
% set(legend_h, 'fontsize',20,'fontweight','b')
% set(plot_h, 'MarkerSize', 7)
% % fn = 'D:\paper\论文7(投)--AIChE鲁棒混合BayesianPCR在软测量中的应用\AIChE\Pictures\Fig3d'; 
% % print(gcf, '-depsc2', fn)
% 
% figure(15)
...
% set(legend_h, 'fontsize',20,'fontweight','b')
% set(plot_h, 'MarkerSize', 7)
% % fn = 'D:\paper\论文7(投)--AIChE鲁棒混合BayesianPCR在软测量中的应用\AIChE\Pictures\Fig3e'; 
% % print(gcf, '-depsc2', fn)
% 
% figure(16)
...
% set(legend_h, 'fontsize',20,'fontweight','b')
% set(plot_h, 'MarkerSize', 20)
% % fn = 'D:\paper\论文7(投)--AIChE鲁棒混合BayesianPCR在软测量中的应用\AIChE\Pictures\Fig3f'; 
% % print(gcf, '-depsc2', fn)
% 
% figure(17)
% plot(newdataY(2,:),GMMres.xstar(2,:),'x','Color',[0, 191, 255]/255); hold on
% lh1 = line([-5 30],[-5 30]);
% set(lh1,'LineWidth',1.75);
% xlabel('$ \mathbf{y_{2}} $','interpreter','latex','fontsize',30,'fontweight','b');
% ylabel('$ \mathbf{\hat{y}_{2}}$','interpreter','latex','fontsize',30,'fontweight','b');
...
% set(legend_h, 'fontsize',20,'fontweight','b')
% set(plot_h, 'MarkerSize', 10)
% % fn = 'D:\paper\论文7(投)--AIChE鲁棒混合BayesianPCR在软测量中的应用\AIChE\Pictures\Fig3g'; 
% % print(gcf, '-depsc2', fn)
% 
% figure(18)
...
% set(legend_h, 'fontsize',20,'fontweight','b')
% set(plot_h, 'MarkerSize', 7)
% % fn = 'D:\paper\论文7(投)--AIChE鲁棒混合BayesianPCR在软测量中的应用\AIChE\Pictures\Fig3h'; 
% % print(gcf, '-depsc2', fn)
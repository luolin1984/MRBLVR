...
OPTIONS.dataset = 'NoOutlier';
% OPTIONS.NOutliers = 20;
dataExp = NumExp_with_Outliers(OPTIONS);

Data = [dataExp.dataX, dataExp.dataY];% Data = [dataExp.outlierX, dataExp.outlierY]
Data = Data';
...
oDataX = Data(1:5,:); oDataY = Data(6:end,:);%oDataX = dataExp.outlierX'; oDataY = dataExp.outlierY';
